...
<html>
	...
	<body class="text-center">
		...
		<div class="col-md-4">
			...
			<div class="kiinnostavat"></div><br><div class="lomake"><a href="kayttajat/lomake" style="color:red;">Siirry luomaan profiili</a><br>
			<!-- Testausta varten -->
			<a href="kayttajat/profiilisivu" style="color:red;">Näytä</a></div>
		</div>
		<div class="col-md-4">
